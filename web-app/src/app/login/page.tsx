    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4">
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-secondary mt-4">Welcome back, traveler</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/forgot-password" className="text-sm text-map hover:text-map/80 transition">
                  Forgot password?
                </Link>
              </div>
              <div className="relative">
        ...
        <p className="text-center text-secondary mt-6">
          ...
          <Link href="/register" className="text-map hover:text-map/80 font-medium transition">
            Sign up for free
          </Link>
        </p>
      </div>
